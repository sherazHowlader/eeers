        ...
        <div class="scrollbar-sidebar">
            <div class="app-sidebar__inner">
                ...
                <div class="text-center mb-4 mt-3">
                    ...
                    <h6>
                        <i> <?php $user = $_SESSION['userData'];
                            echo $user['role_name']; ?> </i>
                    </h6>
                </div>
                ...
                <ul class="vertical-nav-menu">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Dashboard/home" class="<?php if ($crtlName == "Dashboard") {
                                                                                    echo "mm-active";
                                                                                } else {
                                                                                    echo "no-active";
                                                                                } ?>">
                    ...
                    <li class="<?php if ($methodName == "update" || $methodName == "view") {
                                    echo "mm-active";
                                } else {
                                    echo "no-active";
                                } ?>">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo BASE_URL; ?>/Category/view" class="<?php if ($crtlName == "Category" || $methodName == "catEdit") {
                                                                                            echo "mm-active";
                                                                                        } else {
                                                                                            echo "no-active";
                                                                                        } ?>">
                            ...
                            <li>
                                <a href="<?php echo BASE_URL; ?>/Area/view" class="<?php if ($crtlName == "Area") {
                                                                                        echo "mm-active";
                                                                                    } else {
                                                                                        echo "no-active";
                                                                                    } ?>">
                            ...
                            <li>
                                <a href="<?php echo BASE_URL; ?>/Outlet/view" class="<?php if ($crtlName == "Outlet") {
                                                                                        echo "mm-active";
                                                                                    } else {
                                                                                        echo "no-active";
                                                                                    } ?>">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Store/home" class="<?php if ($crtlName == "Store") {
                                                                                echo "mm-active";
                                                                            } else {
                                                                                echo "no-active";
                                                                            } ?>">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Sales/home" class="<?php if ($crtlName == "Sales") {
                                                                                echo "mm-active";
                                                                            } else {
                                                                                echo "no-active";
                                                                            } ?>">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Damage/home" class="<?php if ($crtlName == "Damage") {
                                                                                echo "mm-active";
                                                                            } else {
                                                                                echo "no-active";
                                                                            } ?>">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Account/home" class="<?php if ($crtlName == "Account") {
                                                                                    echo "mm-active";
                                                                                } else {
                                                                                    echo "no-active";
                                                                                } ?>">
                    ...
                    <li>
                        <a href="<?php echo BASE_URL; ?>/Index/users" class="<?php if ($methodName == "users" || $methodName == "edit") {
                                                                                echo "mm-active";
                                                                            } else {
                                                                                echo "no-active";
                                                                            } ?>">
